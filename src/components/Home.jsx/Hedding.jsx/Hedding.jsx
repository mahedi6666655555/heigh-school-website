...
const Hedding = () => {
    return (
        <div>
            <div className='w-full h-screen shadow-lg md:flex items-center'>
                <div className=' md:first-letter:w-1/2  '>
                    <img className='md:ml-5' src="https://img.freepik.com/free-photo/close-up-portrait-young-guy-with-curly-hair_176532-8156.jpg?size=626&ext=jpg&ga=GA1.2.2099233669.1673796942&semt=ais" alt="" />
                </div>
